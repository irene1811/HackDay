...
public class Questions {
    ...
    private String mChoices[][]={
            {"presenting large amounts of information in ways that are universally understandable or easy to interpret and spot patterns, trends and correlations","Making graphs that only you can understand","Visualizing data… DUHHH", "Both A and C"},
            {"Internal internet used to transfer information internally","Internal internet used to transfer information to the outside company", "Internal network designed to serve the internal informational needs of a single organization", "Internal network designed to transfer the information between two organization"},
            ...
            {"Liability Insurance", "B) Automobile Insurance","Collision Insurance", "Health Insurance"},
            ...
            {"product's price minus all associated variable costs, resulting in the incremental profit earned for each unit sold aka gross profit", "The amount of money that has been contributed to a project", "Total money made", "Something else"}
    };

    private String mAnswers[]={"Both A and C","Internal network designed to serve the internal informational needs of a single organization","Application Programming Interface","A risk retention group","Liability Insurance", "Retention", "Sunk cost","Standard deviation","Statistical method of examining a dataset having one or more variables that are independent defining an outcome", "\"product's price minus all associated variable costs, resulting in the incremental profit earned for each unit sold aka gross profit"};
